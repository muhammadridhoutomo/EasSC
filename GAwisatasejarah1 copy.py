...
# =====================================================================
# BLOK 2: OPERATOR GA (VERSI 1 - KLASIK)
# =====================================================================

def seleksi(populasi, fitness_list):
    total_fitness = sum(fitness_list)
    if total_fitness == 0:
        return random.choice(populasi), random.choice(populasi)
        
    probabilitas = [f/total_fitness for f in fitness_list]
    indeks_populasi = np.arange(len(populasi))
    
    idx_p1, idx_p2 = np.random.choice(indeks_populasi, size=2, p=probabilitas, replace=False)
...
# 7. Simpan File Peta
nama_file_peta = 'Peta_Rute_Berurutan.html'
